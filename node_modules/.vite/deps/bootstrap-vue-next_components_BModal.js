import {
  ...
  useSafeScrollLock
} from "./chunk-JFEFLCI6.js";
import {
  _sfc_main as _sfc_main3,
  getElement
} from "./chunk-QZPEM367.js";
import {
  useShowHide
...
var _hoisted_1 = ["id", "aria-labelledby", "aria-describedby"];
var _hoisted_2 = ["id"];
...
var _sfc_main$1 = defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main3, {
                    ...
                    !unref(props).noHeader ? (openBlock(), createElementBlock("div", {
                      ...
                      renderSlot(_ctx.$slots, "header", normalizeProps(guardReactiveProps(sharedSlots.value)), () => [
                        ...
                        !unref(props).noHeaderClose ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                          hasHeaderCloseSlot.value ? (openBlock(), createBlock(_sfc_main, mergeProps({ key: 0 }, headerCloseAttrs.value, {
                            ...
                            _: 3
                          }, 16)) : (openBlock(), createBlock(_sfc_main2, mergeProps({
                            key: 1,
                    ...
                    !unref(props).noFooter ? (openBlock(), createElementBlock("div", {
                      ...
                      renderSlot(_ctx.$slots, "footer", normalizeProps(guardReactiveProps(sharedSlots.value)), () => [
                        renderSlot(_ctx.$slots, "cancel", normalizeProps(guardReactiveProps(sharedSlots.value)), () => [
                          !unref(props).okOnly ? (openBlock(), createBlock(_sfc_main, {
                            key: 0,
                            ref: "_cancelButton",
...
export {
  _sfc_main$1 as BModal,
  _sfc_main4 as BModalOrchestrator
};
//# sourceMappingURL=bootstrap-vue-next_components_BModal.js.map
